	...
	<div id="wrap">
		<div id="sign_form">
			...
			<form id="login-form" method="post"
				action="__APP__/public/login_do">
				<div class="row relative">
					<label for="id_username">组长学号</label> <input
						id="id_username" type="text" name="stuno">
				</div>

				<div class="row relative">
					<label for="id_password">密码</label> <input id="id_password"
